...
class ExampleXMLDS < ActiveFedora::NokogiriDatastream 
  ...
  set_terminology do |t|
    ...
    t.element(:index_as => [:searchable, :displayable])
  end  
end # class
</pre>
...
class ExampleXMLDS < ActiveFedora::NokogiriDatastream 
  set_terminology do |t|
    t.root(:path => "outer", :xmlns => '')
    t.giraffe(:path => "element", :index_as => [:searchable, :displayable])
  end  
end # class
</pre>
...
class ExampleXMLDS < ActiveFedora::NokogiriDatastream 
  ...
  set_terminology do |t|
    t.root(:path => "outer", :xmlns => '')
    t.element(:attributes=>{:my_attr=>"attr value"}, :index_as => [:searchable, :displayable])
  end  
end # class
</pre>
...
class ExampleXMLDS < ActiveFedora::NokogiriDatastream 
  set_terminology do |t|
    t.root(:path => "outer", :xmlns => '')
    t.gazelle(:path => "element", :attributes=>{:my_attr=>"attr value"}) :index_as => [:searchable, :displayable])
  end  
end
</pre>
...
class ExampleXMLDS < ActiveFedora::NokogiriDatastream 
  ...
  set_terminology do |t|
    t.root(:path => "outer", :xmlns => '')
    t.element {
      t.my_attr(:path => {:attribute=>"my_attr"}, :index_as => [:searchable, :displayable])
    }
  end  
end # class
</pre>
...
class ExampleXMLDS < ActiveFedora::NokogiriDatastream 
  set_terminology do |t|
    t.root(:path => "outer", :xmlns => '')
    t.element {
      t.hippo(:path => {:attribute=>"my_attr"}, :index_as => [:searchable, :displayable])
    }
  end  
end
</pre>
