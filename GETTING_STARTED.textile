...
In action, you will usually use "OM::XML::Document":OM/XML/Document.html to deal with your xml.  Here's how to define a Document class that uses the same Terminology as above

<pre>
  class MyModsDocument
...
You can use "OM::XML::Document.find_by_terms":OM/XML/Document.html#find_by_terms-instance_method to retrieve xml nodes from the datastream.  It returns Nokogiri::XML::Node objects.
...
If you want to get directly to the _values_ within those nodes, use "term_values":OM/XML/TermValueOperators.html#term_values-instance_method
...
For more examples of Querying OM Documents, see {file:QUERYING_DOCUMENTS.textile Querying Documents}

h3. Updating, Inserting & Deleting Elements ("TermValueOperators":OM/XML/TermValueOperators.html)

For more examples of Updating OM Documents, see {file:UPDATING_DOCUMENTS.textile Updating Documents}

h3. Validating Documents

If you have a schema defined in your Terminology's root Term, you can validate any xml document by calling ".validate":OM/XML/Validation.html#validate-instance_method on any instance of your Document classes.
