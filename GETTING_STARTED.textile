...
The API documentation at "http://ci.projectblacklight.org/jenkins/job/om/RB_VERSION=1.9.3/Documentation/OM.html":http://ci.projectblacklight.org/jenkins/job/om/RB_VERSION=1.9.3/Documentation/OM.html provides additional, more targeted information.  We will provide links to the API as appropriate.
...
The solrizer gem provides support for indexing XML documents into Solr based on OM Terminologies.  That process is documented in the "solrizer documentation":http://ci.projectblacklight.org/jenkins/job/solrizer/RB_VERSION=1.9.3/Documentation/file.SOLRIZING_OM_DOCUMENTS.html